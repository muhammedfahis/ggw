...
const initiatives = [
    {
        ...
        tags: ["Water Security", "Technology", "Infrastructure"],
...
const impactStats = [
    ...
    { value: "7", label: "Flagship Initiatives", detail: "Currently active" },
                                    ...
                                    <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 overflow-hidden border border-accent/20">
                                        ...
                                        <div className="relative h-72 lg:h-80 overflow-hidden">
                                            ...
                                            <div className="absolute top-4 left-4">
                                                <span className={`px-4 py-2 rounded-full text-xs font-bold uppercase backdrop-blur-sm ${initiative.status === 'Active'
